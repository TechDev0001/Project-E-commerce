...
icon.addEventListener("click", ()=>{
    ...
    if(ul.className == "showData"){
        ...
        document.getElementById("bar").className = "ri-close-circle-fill";
    }else{
